					...
					<div class="sidebar">
						...
						<div class="widget user-dashboard-menu">
							<ul>
								...
								<li class="active"><a href="/dashboard/like.do"><i class="fa fa-heart"></i> 좋아요 <span>12</span></a></li>
							...
							<tbody>
								<tr>
									...
									<td class="product-details">
										<h3 class="title">나 홀로 캠핑 꿀팁 대방출</h3>
										<span class="add-id"><strong>작성자</strong><br>나는야캠퍼</span>
