						...
						request.onreadystatechange = function() {
							if(request.readyState==4){
								if(request.status==200){
									...
									for(i=0;i<firstImageUrl.length;i++){
										$("#list").empty();
										html+="<tr>";
										html+="<td class='product-thumb'><img width='80px' height='80px'";
										html+="src='"+firstImageUrl[i].textContent+"' alt='camping_thumb'></td>"				
										html+="<td class='product-details'>";
										html+="<h3 class='title'><a href='./detail.do?sampX="+smapX[i].textContent+"&smapY="+smapY[i].textContent+"'>"+facltNm[i].textContent+"</a></h3>";	
										html+="<span class='location'>"+addr1[i].textContent+"</span>";			
										html+="</td>";		
										html+="<td class='product-category'><span class='categories'>"+induty[i].textContent+"</span></td>";		
										...
										html+="'./detail.do?sampX="+smapX[i].textContent+"&smapY="+smapY[i].textContent+"'>";
								   	 ...
								   	 // 마커를 생성합니다
									       ...
									       window.location.href="./detail.do?sampX="+smapX[i].textContent+"&smapY="+smapY[i].textContent;
										});
