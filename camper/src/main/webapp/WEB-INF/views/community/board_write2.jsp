...
<jsp:include page="../../component/header.jsp"></jsp:include>
	...
	<section class="write section">
		<form action="/community/writeOk2.do" method="post" name="wfrm" enctype="multipart/form-data" >
							...
							<div class="col-md-10 offset-md-1 col-lg offset-lg-0">
								<div class="widget write-form">
									...
									<div class="form-group" style="text-align:left;border:1px solid #e0e0e0;background-color:f9f9f9;padding:5px">
										...
										<!-- 버튼 part -->
										<div class="buttons">
											<input type="button" value="목록" class="btn btn-transparent" style="margin-top:20px; margin-right:10px;" onclick="location.href='/community/camptip.do'" />
