...
<%
	...
	ArrayList<NboardTO> boardLists = (ArrayList)request.getAttribute( "boardLists" );
	
	StringBuffer sbHtml = new StringBuffer();

	for( NboardTO to : boardLists ) {
                    ...
                    <div class="col-md-12">
                        ...
                        <!-- 카테고리 -->
                            <div class="category_pd">
                                ...
                                <a href="/adm/manage/bbs/bbs.php?ptype=list&amp;code=bbsBasic&amp;category=65"><b>공지사항</b></a>
                                <font style="color:#ddd;"> | </font>
                            <a href="/adm/manage/bbs/bbs.php?ptype=list&amp;code=bbsBasic&amp;category=66"><b>FAQ</b></a>
                        <!-- 카테고리 끝-->
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-top:1px solid #333;">
                                ...
                                <tr style="">
                                    <td height="30">
                                        <form style="margin:0;">
                                            <input type="hidden" name="idx" value="5279">
                                        ...
                                        <tr>
                                            ...
                                            <td width="7%">
                                                <div class="align_right">
                                                    <input type="button" value="쓰기" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='write-n.html'" />
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
																...
																<tr>
																	<td><select name="searchopt">
																		...
																		for (i = 0; i < searchopt.length; i++) {
																			if (searchopt.options[i].value == "")
																				searchopt.options[i].selected = true;
																		}
																	</script></td>
																	<td><input name="searchkey" type="text" value=""></td>
																	<td>
