        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-8 align-item-center">
                    <div class="border border" style="background-color: rgba(255,255,255,0.75); border-radius: 20px; text-align: center;">
						<img class="mt-4 mb-0" src="./images/login-logo.png">
                        <form action="#">
                            <fieldset class="p-4" style="text-align: start;">
                                <input type="id" placeholder="ID*" class="border p-3 w-90 my-2">
                                ...
                                <div class="loggedin-forgot d-inline-flex my-3">
                                        ...
                                        <label for="registering" class="px-2"><a class="text-primary font-weight-bold" href="terms-condition.html">이용약관</a>에 동의합니다.</label>
                                </div>
                                <button type="submit" class="d-block py-3 px-5 bg-primary text-white  border-0 font-weight-bold mt-3 ml-auto mr-auto" style="text-align: center; font-size: 22px; border-radius: 50px; width: 100%;">Join us</button>
