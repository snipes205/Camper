...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper" style="min-height: 250px;">
			...
			<form action="/admin/write_nok.do" method="post" name="wfrm">
				<table>
					<tr>
						<th class="top">작성자</th>
						<td class="top" colspan="5"><input type="text" name="nick" value="관리자" class="board_view_input_mail" maxlength="10" style="width: 15%;" /></td>
					</tr>
					<tr>
						<th>제목</th>
                   	 	<td colspan="3">
                        	<select name="type" style="height:27px; vertical-align:middle; width: 15%;">
                        		<option value="n">공지사항</option>
                        		<option value="f">FAQ</option>
                    		</select> 
                     		<input name="title" value="" type="text" class="input" style="width:60%;"></td>
						<td colspan="3">
					</tr>   
               		<tr>
                    	<th width="15%" class="content">내용</td>
                    	<td width="85%" class="t_value" colspan="3">
                    		<textarea name="content" id="content"rows="20" cols="100" class="textarea"></textarea>
						</td>
					</tr>
					<tr>
						<th>이미지</th>
						<td colspan="3">
							<br><input type="file" name="img" value="" class="board_view_input" /><br /><br />
						</td>
					</tr>
				</table>
			</div>
             	...
             	<tbody>
                	<tr>
                    	<td align="center">
                        	...
                        	<input type="button" value="쓰기" class="btn_list btn_txt02" style="cursor: pointer;" id="wbtn" onclick="location.href='/admin/write_nok.do'" />
                        </td>
                   	</tr>
              	 </tbody>
           	</table>
