        ...
        <div style="margin:10px 0 0;">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
                        <td align="right">
                        <form action="/admin/delete_oOk.do" method="post" name="dfrm">
                        <input type="hidden" name="oseq" value="<%=oseq %>" />
                                ...
                                <input type="button" value="삭제" class="btn_list btn_txt02" style="cursor: pointer;" id="dbtn" onclick="location.href='/admin/delete_oOk.do'" /> 
                                <input type="button" value="수정" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='/admin/modify_a.do?oseq=<%=oseq %>'" />
