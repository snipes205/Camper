...
<%
	...
	ArrayList<PtableTO> boardListsH = (ArrayList)request.getAttribute( "boardListsH" );
	
	StringBuffer sbHtml = new StringBuffer();

	for( PtableTO to : boardListsH ) {
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="top15">
					<tbody>
						<tr>
							...
							<!-- 카테고리 -->
							<div class="category">
							<a href="/admin/comm.do"><b>전체</b></a><font style="color: #ddd;"> | </font> 
							<a href="/admin/comm_log.do"><b>캠핑로그</b></a><font style="color: #ddd;"> | </font>
							<a href="/admin/comm_honey.do"><b>캠핑꿀팁</b></a><font style="color: #ddd;"> | </font> 
							<a href="/admin/comm_go.do"><b>캠핑가자</b></a>
			</div>
