...
<%
	...
	for( OboardTO to : boardLists ) {
		...
		sbHtml.append( "<input type='hidden' name='idx' value=''>" );
		sbHtml.append( "</form>" );
		sbHtml.append( "</td>" );
		sbHtml.append( "<td>&nbsp;</td>" );
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tbody>
							<tr>
								...
								<input type="button" value="쓰기" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='/admin/write_a.do'" />
							</tr>
						</tbody>
					</table>
			 	</div>
