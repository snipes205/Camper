...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper" style="min-height: 250px;">
			...
			<form action="/admin/write_aok.do" method="post" name="wfrm">
				<table>
					<tr>
						<th class="top">작성자</th>
						<td class="top" colspan="5"><input type="text" name="nick" value="admin1" class="board_view_input_mail" maxlength="10" style="width: 15%;" /></td>
					</tr>
					<tr>
						<th>제목</th>
                   	 	<td colspan="3">
                     		<input name="title" value="" type="text" class="input" style="width:76%;"></td>
						<td colspan="3">
					</tr>   
               		<tr>
             	...
             	<tbody>
                	<tr>
                    	<td align="center">
                        	...
                        	<input type="button" value="쓰기" class="btn_list btn_txt02" style="cursor: pointer;" id="wbtn" onclick="location.href='/admin/write_aok.do'" />
                        </td>
                   	</tr>
              	 </tbody>
           	</table>
